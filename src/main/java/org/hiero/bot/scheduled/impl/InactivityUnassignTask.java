 ...
 * {@link org.hiero.bot.config.ScheduledConfig#inactivityDays()} days and no open PR links to it,
 ...
 * the timer. Enabled via {@link org.hiero.bot.config.FeaturesConfig#inactivityUnassign()}.
 */
