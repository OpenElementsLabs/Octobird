...
- **Frontend container hardening** — 4-stage build (base, deps, build, runner), non-root `appuser`, no pnpm/corepack in runtime, `BACKEND_URL` build arg for API rewrite configuration
