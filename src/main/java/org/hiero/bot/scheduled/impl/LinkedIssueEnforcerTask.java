 ...
 *
 * <p>A PR is closed if it is older than {@link org.hiero.bot.config.ScheduledConfig#linkedIssueEnforcerDays()}
 * days and either:
 * <ul>
 *   <li>its body contains no closing reference to an issue, or</li>
 *   <li>{@link org.hiero.bot.config.ScheduledConfig#requireAuthorAssigned()} is {@code true} and
 *       the PR author is not assigned to the linked issue.</li>
 * </ul>
 *
 * <p>Bot PRs are skipped. Enabled via
 * {@link org.hiero.bot.config.FeaturesConfig#linkedIssueEnforcer()}.
 */
