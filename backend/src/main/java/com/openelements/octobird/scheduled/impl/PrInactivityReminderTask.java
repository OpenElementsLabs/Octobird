 ...
 * new commits for at least {@link com.openelements.octobird.config.ScheduledConfig#prInactivityDays()} days.
 *
 * <p>Bot-authored PRs are skipped. An HTML marker prevents duplicate reminders on the same PR.
 * Enabled via {@link com.openelements.octobird.config.FeaturesConfig#prInactivityReminder()}.
 */
